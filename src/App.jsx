...
const App = () => {
  ...
  if (!user) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-amber-50 p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-64 h-64 bg-yellow-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
      
      <div className="bg-white/60 backdrop-blur-xl p-8 rounded-[3rem] shadow-2xl w-full max-w-sm border border-white/40 text-center relative z-10">
        <div className="w-20 h-20 bg-gradient-to-br from-amber-400 to-amber-600 rounded-3xl mx-auto flex items-center justify-center shadow-lg mb-6 rotate-3">
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-amber-50">
      <div className="text-center space-y-4">
        ...
        <p className="text-amber-800 font-black uppercase tracking-widest text-xs">Menyiapkan Data...</p>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-amber-50 font-sans text-slate-900 max-w-md mx-auto shadow-2xl relative border-x border-amber-100/50">
      <div className="bg-white/70 backdrop-blur-lg px-4 py-4 flex justify-between items-center sticky top-0 z-40 border-b border-amber-100/50 shadow-sm">
        ...
        <div className="flex gap-1">
          ...
          <button onClick={handleLogout} className="p-2 hover:bg-red-100 rounded-full text-red-600 transition-colors" title="Logout">
            <LogOut size={22}/>
          </button>
        </div>
      </div>
